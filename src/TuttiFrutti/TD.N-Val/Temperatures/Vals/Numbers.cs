...
public static class Intersection
{
    ...
    private static readonly double _intersectionFK = 574.5875;

    public static readonly (double K, double C, double F, double delta) FahrnheitWithCelsius = (_intersectionFC + 273.15, _intersectionFC, _intersectionFC, 0.000_000_001);
    public static readonly (double K, double C, double F, double delta) FahrnheitWithKelvin = (_intersectionFK, _intersectionFK - 273.15, _intersectionFK, 0.000_000_001);
