...
public class TestOfAttribute<T1, T2, T3, T4, T5>(params string[] args)
    : TestOfAttribute<T1, T2, T3, T4, T5, Stubs.Basic>(args);
public class TestOfAttribute<T1, T2, T3, T4, T5, T6>(params string[] args)
    : TestOfAttribute<T1, T2, T3, T4, T5, T6, Stubs.Basic>(args);
public class TestOfAttribute<T1, T2, T3, T4, T5, T6, T7>(params string[] args)
    : TestOfAttribute<T1, T2, T3, T4, T5, T6, T7, Stubs.Basic>(args);
public class TestOfAttribute<T1, T2, T3, T4, T5, T6, T7, T8>(params string[] args)
    : TestOfAttribute<T1, T2, T3, T4, T5, T6, T7, T8, Stubs.Basic>(args);
public class TestOfAttribute<T1, T2, T3, T4, T5, T6, T7, T8, T9>(params string[] args)
    : TestOfAttribute<T1, T2, T3, T4, T5, T6, T7, T8, T9, Stubs.Basic>(args);
public class TestOfAttribute<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(params string[] args)
    : TestOfAttribute<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Stubs.Basic>(args);
